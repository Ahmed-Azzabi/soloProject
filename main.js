...
// I used both plain js and jQuery because manipulating values using jQuery variables wasn't possible for some reason even though I made sure I correctly selected those variables. It has to do with how the code is read I think.

//Make it so that if style display none, none of the functions start until you press the (soon to be created) start button

// console.log(
//   window.getComputedStyle(document.getElementById("content"))
//     .display /*if div isn't showing the functions shouldn't start executing*/
// );

// var gameDisplay = window.getComputedStyle(
...
var lose = new Audio("./death.mp3")
var audio = new Audio("./jump-cue.mp3")
